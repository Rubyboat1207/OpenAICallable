...
---@param content string clipboard text content
function setClipboard(content) end

-- Gets the string content of the system clipboard
---@return string content clipboard text content
function getClipboard(content) end

-- Gets the latest Wifi Data
--- @class NetworkStats
--- @field uploadBytes number @The number of uploaded bytes
--- @field downloadBytes number @The number of downloaded bytes
--- @field uploadBytesXSeconds number @The number of uploaded bytes in the last X seconds
--- @field downloadBytesXSeconds number @The number of downloaded bytes in the last X seconds
--- @field timestamp number @The timestamp, in seconds since the epoch
---@return NetworkStats content clipboard text content
function getWifiData() end
...
-- Adds a text widget to a specific HUD window. Do not use in render, only in init.
---@param handle number The handle of the HUD window.
...
-- Adds a checkbox widget to a specific HUD window. Do not use in render, only in init.
---@param handle number The handle of the HUD window.
---@param identifier string The desired identifier, must be unique
---@param renderPriority number Lower number renders first, higher number renders last
...
-- Adds a buttton widget to a specific HUD window. Do not use in render, only in init.
---@param handle number The handle of the HUD window.
---@param identifier string The desired identifier, must be unique
---@param renderPriority number Lower number renders first, higher number renders last
function addButtonWidget(handle, identifier, renderPriority) end

-- Adds an onclick callback to a specific Button <br/><strong>(WARNING: Only 1 callback per button allowed)</strong>. OnClick IS REQUIRED FOR BUTTONS
---@param handle number The handle of the HUD window.
---@param identifier string The desired identifier, must be unique
---@param callback string the identifier of a callback file
